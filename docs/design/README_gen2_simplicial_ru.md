...
```
src/        библиотека (lanthanide_separation)
scripts/    исполняемые эксперименты и анализ
tests/      705 тестов, из них 19 модулей с проверками на leakage
slurm/      обёртки для кластера (по умолчанию DRY_RUN=1)
